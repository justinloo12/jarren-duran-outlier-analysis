...
| 2026 | 74.38 | 47.1% | 79.5 | 7.51 | 5.6 | 679 |

**Duran's 2026 bat speed (74.38 mph) is +1.04 mph versus his 2024–25 average** (73.34), and his fast-swing rate has climbed 34% → 45% → 47%. A physically declining hitter swings *slower*; Duran is swinging harder, longer (7.47 → 7.51 ft) and steeper (3.2° → 5.6°). Whatever 2026 is, it is not a slowing bat.

## Where the whiffs and chases actually live

| Cut | 2024 | 2025 | 2026 |
|-----|-----:|-----:|-----:|
| Whiff% overall | 21.8% | 26.2% | 32.4% |
| Whiff% vs fastballs ≥95 | 15.8% | 19.5% | 28.8% |
| Whiff% vs fastballs | 17.3% | 20.1% | 26.6% |
| Whiff% vs breaking | 29.9% | 33.3% | 42.7% |
| Whiff% vs offspeed | 23.2% | 34.0% | 32.6% |
| Chase% overall | 28.1% | 31.1% | 34.8% |
| Chase% vs fastballs | 21.2% | 26.6% | 30.8% |
| Chase% vs breaking | 37.8% | 34.7% | 38.2% |
| Chase% vs offspeed | 32.7% | 36.9% | 39.2% |
| Chase% breaking, down-and-away | 47.1% | 38.4% | 33.8% |
| Swing% in the 'chase' attack zone | 25.6% | 29.1% | 38.6% |
| In-zone contact% | 87.4% | 86.9% | 83.7% |

Three honest observations:

1. **The whiff spike is everywhere, including premium velocity** (≥95 FB: 15.8% → 19.5% → 28.8%, n=163 swings in 2026). On its own that reads like a slowing bat — but the bat is *measured* and it is not slowing. Rising whiffs on a rising bat speed + a longer, steeper swing is the signature of **selling out**: more intent, less bat control.
2. **The chase leak is velocity and offspeed, not the classic breaking-ball-in-the-dirt.** Chase on fastballs jumped 21.2% → 30.8% and on offspeed 32.7% → 39.2%, while chase on breaking balls down-and-away has actually *improved* (47.1% → 33.8%, small n). He is not getting fooled by spin; he is starting the A-swing early and expanding off velocity — an approach/timing problem.
3. **In-zone contact is down** (87.4% → 83.7%) — the cost of the max-intent swing showing up even on hittable pitches.
