...
Quantified: weighting the scenarios 60/40 (vs an agnostic 50/50) puts the blended P(rest-of-season wRC+ ≥ 100) at **58%** (vs 56% agnostic; the pure scenarios are 65% healthy / 47% eroded).
